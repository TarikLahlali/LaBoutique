      ...
      >
        <Left>
          ...
          <MenuLinks style={{ opacity: `${opacity}` }}>
            <MenuItem to="/products/Dame">Dame</MenuItem>
            <MenuItem to="/products/Herre">Herre</MenuItem>
          </MenuLinks>
        </Left>
        ...
        <Right>
          {!currentUser ? (
            ...
            >
              logg ut
              <DropdownContent>{`Du er logged inn som ${Capitalize(
                currentUser
              )}`}</DropdownContent>
            </Dropdown>
          )}
